...
namespace TP_02
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Muestro solo Dulces
            Console.WriteLine(Changuito.Mostrar(changoDeCompras, ETipo.Dulce));
            Console.WriteLine("<---------------------------------------------->");
            Console.ReadKey();
            Console.Clear();

            // Muestro solo Leches
            Console.WriteLine(Changuito.Mostrar(changoDeCompras, ETipo.Leche));
            Console.WriteLine("<---------------------------------------------->");
            Console.ReadKey();
            Console.Clear();

            // Muestro solo Snacks
            Console.WriteLine(Changuito.Mostrar(changoDeCompras, ETipo.Snacks));
            Console.WriteLine("<---------------------------------------------->");
            Console.ReadKey();
        }
    }
